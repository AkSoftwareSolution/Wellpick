...
public class SubscriptionProduct {
    ...
    public SubscriptionProduct(Context context, MyBillingListener myBillingListener){
 ...
 private void initBillingLibrary(){
    ...
    public void requestPurchases(String productId,String offerId){
...
//-----------------------------requestPurchases end here ---------------------------------
    private void launchBillingFlow(ProductDetails productDetails){
        ...
        for (ProductDetails.SubscriptionOfferDetails offer: productDetails.getSubscriptionOfferDetails()){
            if (offer.getOfferId()!=null&&offer.getOfferId().contains(offerId)){
                offerDetails=offer;
                break;
            }
        }
